"""
Update All SageMaker Endpoints to Cheaper Instance Type - For Jupyter Notebook

⚠️  NOTE: Using ml.c5.large (cheapest valid instance type for SageMaker inference).
ml.t3.medium is NOT available for SageMaker endpoints.
...
print(f"✅ Ready to update {len(endpoint_list)} endpoint(s) to ml.c5.large")
...
for ep in endpoint_list:
    ...
    print(f"  New: ml.c5.large = ${new_monthly:.2f}/month")
...
# ============================================================================
# CELL 3: Update All Endpoints (CONFIRM FIRST!)
# ============================================================================

# Use ml.c5.large (cheapest valid instance type for SageMaker inference)
# ml.t3.medium is NOT available for SageMaker endpoints
NEW_INSTANCE_TYPE = 'ml.c5.large'  # ~$0.10/hour = ~$72/month
